  ...
  <script>
    $(document).ready(function() {
      ...
      $(".activate-billing-btn").click(function() {
        ...
        window.location.href = "UAAB.php?customerId=" + customerId;
      });
...
<body><img src="ufone.png" alt="Ufone Logo" class="logo-image">
      ...
      if ($result->num_rows > 0) {
          while ($row = $result->fetch_assoc()) {
              ...
              if ($row['status'] == 'In Active') {
                echo "<td><button class='activate-billing-btn' data-customer-id='" . $row['customerId'] . "'>Activate Billing</button></td>";
              } else {
                echo "<td></td>";
              }
